...
- (void)viewDidLoad {
    ...
    self.textV = [[UITextView alloc]initWithFrame:CGRectMake(0, 20 + TOP_BAR_HEIGHT, SCREEN_WIDTH, 150)];
    self.textV.backgroundColor = RGB(255, 255, 255);
    [self.view addSubview:self.textV];
    
    self.saveBtn = [[UIButton alloc]initWithFrame:CGRectMake(25, TOP_BAR_HEIGHT + 200, SCREEN_WIDTH - 50, 45)];
